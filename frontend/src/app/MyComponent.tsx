...
export const MyComponent = ({
  ...
  const addChat = () => {
    if(chatRef.current) {
      ...
      if(!chat) return;
      setChats( chats => [...chats, {message: chat, votes: 0, chatId: "skdf" }]);
      sendChat(chat); 
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-2 mt-4 space-y-4">
      ...
      <div className='flex border min-w-[900px] rounded-md'>
        <div className='text-center border-r w-full'>
          <div className='p-2'>All chats</div>
        ...
        +          </div>
            ...
            <div className='flex gap-2 p-2 border-t'>
              <input 
                ...
                ref={chatRef}
              />
              <button className='w-full flex items-center justify-center px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 sm:w-auto dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:border-gray-700' onClick={addChat}>Send</button>
            </div>
          </div>
        </div>
        {/* Medium Upvotes */}
        <div className='text-center border-r w-full'>
          ...
          <div className='border-t'>
              <div className='flex flex-col max-h-96 overflow-auto'>
                {chats.filter((chat) => chat.votes >= upVotes1 && chat.votes < upVotes2)
                .map((chat, i) => (
